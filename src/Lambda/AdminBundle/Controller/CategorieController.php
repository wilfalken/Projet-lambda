...
class CategorieController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Lambda\LambdaBundle\Form\CategorieType', $categorie);
    ...
    {
        $deleteForm = $this->createDeleteForm($categorie);
        $editForm = $this->createForm('Lambda\LambdaBundle\Form\CategorieType', $categorie);
    ...
    private function createDeleteForm(Categorie $categorie)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('categorie_delete', array('id' => $categorie->getIdcategorie())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
