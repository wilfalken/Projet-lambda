...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 13 Juin 2017 à 18:15
...
(6, 30, 'rue des acacias', '0', 2542, 'rouen', 'FR', 1),
(7, 40, 'rue du chose', 'au fond de la route', 57463, 'strasbourg', 'FR', 0),
(9, 120, 'rue du four', 'ker', 34000, 'TOURS', 'FR', 0),
(11, 1322, 'rue du tambour', 'lieu-dit kercharon', 34000, 'valence', 'FR', 0),
(12, 12, 'rue du clergé', '0', 56000, 'rennes', 'FR', 0),
(13, 5, 'impasse du tranchis', 'kerglasier', 56230, 'Questembert', 'FR', 1),
(14, 25, 'rue des gorges', '0', 35000, 'rennes', 'FR', 1),
(15, 250, 'rue des rouge-gorges', 'lieu-dit pierrebattue', 56000, 'Vannes', 'FR', 0);
...
(9, 8, '2017-06-09 15:55:20', '2017-07-09 15:55:20', 10, 8, 13, 'P1M');
...
(2, '6de82ab606659d6642392497e21746ce.gif', '2017-04-11 10:15:20', 4, 5, 'Impeccable'),
(7, NULL, '2017-04-21 10:26:58', 1, 6, 'comme neuf'),
(8, NULL, '2017-04-21 10:29:08', 1, 6, 'Quelques rayures'),
(9, NULL, '2017-04-21 10:39:52', 1, 6, 'Bon etat'),
(10, NULL, '2017-06-09 15:03:20', 3, 8, 'Excellent'),
(11, 'a941c2aeb346008a62372bc44d59ecf4.jpeg', '2017-06-09 15:38:22', 1, 9, 'Comme neuf');
...
(1, 'enjoliveurs x4', 'enjoliveurs en aluminium', NULL, 1, 2),
(3, 'La fille de Brooklyn - Guillaume Musso', 'Je me souviens très bien de cet instant. Nous étions face à la mer. L\'horizon scintillait.', 'b8150ac92fca79e5c8937f4b350966cd.jpeg', 1, 1),
(4, 'tableau de Pablo Picasso', 'triptyque représentant quelques cubes', '56a809dcc683168be25070a9a0f23e40.jpeg', 1, 3),
(6, 'Symfony pour les nuls', 'Livre permettant d\'apprendre Symfony', '5f4706e50cb88047a40e24901145b60f.jpeg', 1, 1);
...
(31, 'Demande de pret de l\'objet : blah ef', '<div class=\"container\">L\'utilisateur admin vous demande le prêt de l\'objet : blah ef. Vous pouvez soit accepter, soit refuser le pret de cet objet.</br>Si vous acceptez, nous vous invitons à contacter le demandeur par l\'intermédiare de ce bouton, pour convenir d\'un rendez-vous par exemple:<a class=\"btn btn-primary btn-xs\" href=\"../message/5/new\">Contacter le demandeur</a></br>Après cela, je vous invite à signaler à l\'application, et afin d\'éviter les problèmes, un nouvel emprunt de cet objet, par l\'intérmédiaire de ce bouton :<a class=\"btn btn-primary btn-xs\" href=\"../emprunt/2/5/new\">Nouvel emprunt</a></br>Bonne journée et amusez-vous bien !</div>', 'dempret', '2017-06-08 14:03:40', 5, 5),
(32, 'Demande de renseignement', '<p>Bonjour, serait-il possible d\'avoir un renseignement ?</p>', 'toadmin', '2017-06-08 22:52:55', 5, 6),
(33, 'renseignement ?', '<p>possible d\'avoir un renseignement ?</p>', 'toadmin', '2017-06-08 22:55:31', 5, 6),
(34, 'Pourquoi pas', '<p>Bien sur je suis tout &agrave; fait d\'accord pour pr&eacute;ter cet objet...</p>\r\n<p>Pourrions nous nous rencontrer afin de vous le faire parvenir ?</p>', 'touser', '2017-06-09 13:05:13', 6, 5),
(35, 'Demande de pret de l\'objet : La fille de Brooklyn ', '<div class=\"container\">L\'utilisateur guillaume2 vous demande le prêt de l\'objet : La fille de Brooklyn - Guillaume Musso. Vous pouvez soit accepter, soit refuser le pret de cet objet.</br>Si vous acceptez, nous vous invitons à contacter le demandeur par l\'intermédiare de ce bouton, pour convenir d\'un rendez-vous par exemple:<a class=\"btn btn-primary btn-xs\" href=\"../message/9/new\">Contacter le demandeur</a></br>Après cela, je vous invite à signaler à l\'application, et afin d\'éviter les problèmes, un nouvel emprunt de cet objet, par l\'intérmédiaire de ce bouton :<a class=\"btn btn-primary btn-xs\" href=\"../emprunt/10/9/new\">Nouvel emprunt</a></br>Bonne journée et amusez-vous bien !</div>', 'dempret', '2017-06-09 15:39:43', 8, 9),
(36, 'Ok ok', '<p>J\'accepte avec plaisir votre demande de pr&ecirc;t...</p>\r\n<p>&nbsp;</p>\r\n<p>Pourquoi ne pas se voir ce soir ?</p>', 'touser', '2017-06-09 15:47:39', 9, 8),
(37, 'Précisions', '<p>Bonjour,</p>\r\n<p>je souhaiterais avoir plus de pr&eacute;cisions sur vos enjoliveurs.</p>\r\n<p>&nbsp;</p>\r\n<p>Meci d\'avance,&nbsp;<img src=\"../../../js/tinymce/plugins/emoticons/img/smiley-wink.gif\" alt=\"wink\" /></p>', 'touser', '2017-06-13 17:01:14', 9, 8);
...
(7, 'aze2', 'aze2', 'aze@aze.fr', 'aze@aze.fr', 1, 1, '$2y$13$BtToTfmuBYq1INQg1146Ce8M.XfmazlkS15aHLsQdAHW.j.ZJ1PSO', 'azert', '2017-06-08 15:51:45', 202020202, 0, '[\"ROLE_USER\"]'),
(8, 'guillaume', 'guillaume', 'aze@aze.fr', 'aze@aze.fr', 1, 1, '$2y$13$nTfuE.Pfth2tuwyIQ2QTT.XvrkqPKnLyq.V5OCJp2GL1Yy717ByLW', 'guillaume', '2017-06-09 13:45:57', 202020202, 0, '[\"ROLE_USER\"]'),
(9, 'guillaume2', 'guillaume2', 'aze@aze.fr', 'aze@aze.fr', 1, 1, '$2y$13$LeuFYD0HTWKw7LilE0.T2eWaSSgOFvPbGNaHqotSyQhg6bmk9E9B.', 'guillaume2', '2017-06-09 13:46:39', 202020202, 0, '[\"ROLE_USER\"]');
...
--
ALTER TABLE `emprunt`
  MODIFY `idEmprunt` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `exemplaire`
  MODIFY `idexemplaire` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
